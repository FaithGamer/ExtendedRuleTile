...
{
    /// <summary>
    /// The Editor for a ExtendedRuleTile.
    /// </summary>
    [CustomEditor(typeof(ExtendedRuleTile), true)]
    [CanEditMultipleObjects]
    public class ExtendedRuleTileEditor : Editor
    {
        ...
        private static readonly string k_UndoName = L10n.Tr("Change ExtendedRuleTile");
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent emptyExtendedRuleTileInfo =
            ...
            public static readonly GUIContent tilingRulesExtendDimension = EditorGUIUtility.TrTextContent("Extend Dimension"
                , "The dimension of the repeating pattern");
        ...
        /// <summary>
        /// The ExtendedRuleTile being edited
        /// </summary>
        public ExtendedRuleTile tile => target as ExtendedRuleTile;
        ...
        /// <summary>
        /// Whether the ExtendedRuleTile can extend its neighbors beyond directly adjacent ones
        /// </summary>
        ...
        /// <summary>
        /// OnEnable for the ExtendedExtendedRuleTileEditor
        /// </summary>
        public virtual void OnEnable()
        {
            m_ReorderableList = new ReorderableList(tile != null ? tile.m_TilingRules : null, typeof(ExtendedRuleTile.TilingRule), true, true, true, true);
        ...
        /// <summary>
        /// OnDisable for the ExtendedExtendedRuleTileEditor
        /// </summary>
        ...
        public virtual BoundsInt GetRuleGUIBounds(BoundsInt bounds, ExtendedRuleTile.TilingRule rule)
        {
            if (extendNeighbor)
            {
                bounds.xMin--;
        ...
        {
            ExtendedRuleTile.TilingRule rule = tile.m_TilingRules[index];
        ...
        public float GetElementHeight(ExtendedRuleTile.TilingRule rule)
        {
            BoundsInt bounds = GetRuleGUIBounds(rule.GetBounds(), rule);

            float inspectorHeight = GetElementHeight(rule as ExtendedRuleTile.TilingRuleOutput);
        ...
        public float GetElementHeight(ExtendedRuleTile.TilingRuleOutput rule)
        {
            float inspectorHeight = k_DefaultElementHeight + k_PaddingBetweenRules;

            switch (rule.m_Output)
            {
                case ExtendedRuleTile.TilingRuleOutput.OutputSprite.Random:
                case ExtendedRuleTile.TilingRuleOutput.OutputSprite.Animation:
                    inspectorHeight = k_DefaultElementHeight + k_SingleLineHeight * (rule.m_Sprites.Length + 3) + k_PaddingBetweenRules;
                    break;
                 case ExtendedRuleTile.TilingRuleOutput.OutputSprite.Extended:
                    inspectorHeight = k_DefaultElementHeight + k_SingleLineHeight * (rule.m_Sprites.Length + 3) + k_PaddingBetweenRules;
                    break;
            }
        ...
        /// <summary>
        /// Gets the GUI matrix size for a Rule of a ExtendedRuleTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a ExtendedRuleTile.</returns>
        ...
        private void OnAddElement(object obj)
        {
            ...
            ExtendedRuleTile.TilingRule rule = new ExtendedRuleTile.TilingRule();
            rule.m_Output = ExtendedRuleTile.TilingRuleOutput.OutputSprite.Single;
            ...
            ResizeExtendedRuleTileList(count + 1);
        ...
        /// <summary>
        /// Saves any changes to the ExtendedRuleTile
        /// </summary>
        ...
        /// </summary>
        /// <param name="target">ExtendedRuleTile which has been updated</param>
        public static void UpdateAffectedOverrideTiles(ExtendedRuleTile target)
        {
        ...
        /// <summary>
        /// Gets all RuleOverrideTiles which override the given ExtendedRuleTile
        /// </summary>
        /// <param name="target">ExtendedRuleTile which has been updated</param>
        /// <returns>A list of RuleOverrideTiles which override the given ExtendedRuleTile</returns>
        public static List<RuleOverrideTile> FindAffectedOverrideTiles(ExtendedRuleTile target)
        {
        ...
        /// <summary>
        /// Draws the Inspector GUI for the ExtendedExtendedRuleTileEditor
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            if (count < 0)
                count = 0;
            if (EditorGUI.EndChangeCheck())
                ResizeExtendedRuleTileList(count);
            ...
            if (count == 0)
            {
                ...
                DisplayClipboardText(Styles.emptyExtendedRuleTileInfo, rect);
        ...
        private void ResizeExtendedRuleTileList(int count)
        {
            ...
            if (isEmpty)
            {
                for (int i = 0; i < count; ++i)
                    tile.m_TilingRules[i] = new ExtendedRuleTile.TilingRule();
            }
            UpdateTilingRuleIds();
        }

        /// <summary>
        /// Draw editor fields for custom properties for the ExtendedRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Gets the index for a Rule with the ExtendedRuleTile to display an arrow.
        /// </summary>
        /// <param name="position">The relative position of the arrow from the center.</param>
        /// <returns>Returns the index for a Rule with the ExtendedRuleTile to display an arrow.</returns>
        ...
        public virtual void RuleOnGUI(Rect rect, Vector3Int position, int neighbor)
        {
            switch (neighbor)
            {
                case ExtendedRuleTile.TilingRuleOutput.Neighbor.This:
                    GUI.DrawTexture(rect, arrows[GetArrowIndex(position)]);
                    break;
                case ExtendedRuleTile.TilingRuleOutput.Neighbor.NotThis:
        ...
        public virtual void RuleTransformOnGUI(Rect rect, ExtendedRuleTile.TilingRuleOutput.Transform ruleTransform)
        {
            switch (ruleTransform)
            {
                case ExtendedRuleTile.TilingRuleOutput.Transform.Rotated:
                    GUI.DrawTexture(rect, autoTransforms[0]);
                    break;
                case ExtendedRuleTile.TilingRuleOutput.Transform.MirrorX:
                    GUI.DrawTexture(rect, autoTransforms[1]);
                    break;
                case ExtendedRuleTile.TilingRuleOutput.Transform.MirrorY:
                    GUI.DrawTexture(rect, autoTransforms[2]);
                    break;
                case ExtendedRuleTile.TilingRuleOutput.Transform.Fixed:
                    GUI.DrawTexture(rect, autoTransforms[3]);
                    break;
                case ExtendedRuleTile.TilingRuleOutput.Transform.MirrorXY:
        ...
        public void RuleNeighborUpdate(Rect rect, ExtendedRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position)
        {
        ...
        public void RuleTransformUpdate(Rect rect, ExtendedRuleTile.TilingRule tilingRule)
        {
            if (Event.current.type == EventType.MouseDown && ContainsMousePosition(rect))
            {
                tilingRule.m_RuleTransform = (ExtendedRuleTile.TilingRuleOutput.Transform)(int)Mathf.Repeat((int)tilingRule.m_RuleTransform + GetMouseChange(), Enum.GetValues(typeof(ExtendedRuleTile.TilingRule.Transform)).Length);
                GUI.changed = true;
                Event.current.Use();
            }
        }
        ...
        /// <summary>
        /// Draws a Rule Matrix for the given Rule for a ExtendedRuleTile.
        /// </summary>
        ...
        public virtual void RuleMatrixOnGUI(ExtendedRuleTile tile, Rect rect, BoundsInt bounds, ExtendedRuleTile.TilingRule tilingRule)
        {
        ...
        /// <summary>
        /// Draws a Rule Matrix Icon for the given matching Rule for a ExtendedRuleTile with the given position
        /// </summary>
        /// <param name="tilingRule">Tile to draw rule for.</param>
        /// <param name="neighbors">A dictionary of neighbors</param>
        /// <param name="position">The relative position of the neighbor matching Rule</param>
        /// <param name="rect">GUI Rect to draw icon at</param>
        public void RuleMatrixIconOnGUI(ExtendedRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position, Rect rect)
        {
        ...
        public virtual void SpriteOnGUI(Rect rect, ExtendedRuleTile.TilingRuleOutput tilingRule)
        {
        ...
        public void RuleInspectorOnGUI(Rect rect, ExtendedRuleTile.TilingRuleOutput tilingRule)
        {
            float y = rect.yMin;
            ...
            tilingRule.m_Output = (ExtendedRuleTile.TilingRuleOutput.OutputSprite)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_Output);
            y += k_SingleLineHeight;

            if (tilingRule.m_Output == ExtendedRuleTile.TilingRuleOutput.OutputSprite.Animation)
            {
            ...
            if (tilingRule.m_Output == ExtendedRuleTile.TilingRuleOutput.OutputSprite.Random)
            {
                ...
                tilingRule.m_RandomTransform = (ExtendedRuleTile.TilingRuleOutput.Transform)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_RandomTransform);
                y += k_SingleLineHeight;
            }
                ...
                case EventType.DragPerform:
                    {
                        ...
                        ResizeExtendedRuleTileList(dragAndDropSprites.Count);
        ...
        /// <summary>
        /// Whether the ExtendedRuleTile has a preview GUI
        /// </summary>
        ...
        /// <summary>
        /// Draws the preview GUI for the ExtendedRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Creates a Preview for the ExtendedRuleTile.
        /// </summary>
        ...
        /// <summary>
        /// Renders a static preview Texture2D for a ExtendedRuleTile asset
        /// </summary>
        /// <param name="assetPath">Asset path of the ExtendedRuleTile</param>
        ...
        /// <returns>Texture2D containing static preview for the ExtendedRuleTile asset</returns>
        ...
        /// </summary>
        [Serializable]
        class ExtendedRuleTileRuleWrapper
        {
            /// <summary>
            /// List of Rules to serialize
            /// </summary>
            [SerializeField]
            public List<ExtendedRuleTile.TilingRule> rules = new List<ExtendedRuleTile.TilingRule>();
        }

        /// <summary>
        /// Copies all Rules from a ExtendedRuleTile to the clipboard
        /// </summary>
        /// <param name="item">MenuCommand storing the ExtendedRuleTile to copy from</param>
        [MenuItem("CONTEXT/ExtendedRuleTile/Copy All Rules")]
        public static void CopyAllRules(MenuCommand item)
        {
            ExtendedRuleTile tile = item.context as ExtendedRuleTile;
            if (tile == null)
                return;

            ExtendedRuleTileRuleWrapper rulesWrapper = new ExtendedRuleTileRuleWrapper();
        ...
        /// <summary>
        /// Pastes all Rules from the clipboard to a ExtendedRuleTile
        /// </summary>
        /// <param name="item">MenuCommand storing the ExtendedRuleTile to paste to</param>
        [MenuItem("CONTEXT/ExtendedRuleTile/Paste Rules")]
